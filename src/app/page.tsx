...
export default function Home() {
  ...
  const projects = [
    {
      ...
      description:
        "A complete vehicle rental management platform with real-time availability tracking and automated booking system.",
      technologies: [
        "Java",
        "Spring Boot",
        "PostgreSQL",
      ...
      githubUrl: "https://github.com/DennisMwauraKA/vehicle-backend.git",
      apiDocsUrl: "#",
      details: {
        architecture:
          "Layered architecture with clear separation between API, service, and repository layers",
        features: [
        ...
        challenges: [
          ...
          },
          {
            ...
            solution:
              "Created rules engine using Spring Expression Language (SpEL)",
          },
        ],
        performance:
          "Handles 500+ concurrent bookings with <300ms response time",
        images: [
    ...
    },
    {
      ...
      description:
        "Microservices-based learning platform serving educational content to 10,000+ students.",
      technologies: [
        "Java",
        "Spring Cloud",
        "KeyCloak",
      ...
      githubUrl:
        "https://github.com/DennisMwauraKA/learning-management-system.git",
      apiDocsUrl: "#",
      details: {
  ...
  return (
    <main className="min-h-screen p-1 max-w-6xl mx-auto space-y-16 bg-gradient-to-br from-red-300 via-red to-gray-300 dark:from-gray-900 dark:via-gray-950 dark:to-gray-800">
      ...
      <section id="about" className="scroll-mt-16">
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm">
          ...
          <p className="text-gray-700">
            My approach combines clean architecture principles with practical
            performance optimizations to deliver systems that are both
            maintainable and efficient under heavy loads.
          </p>
            ...
            >
                    ...
                    {project.details.images.map((image, i) => (
                      <div key={i} className="border rounded overflow-hidden">
                        <Image
                          ...
                          height={600}
                        />
                        <p className="text-xs text-center p-1 bg-gray-100">
                          {image.alt}
                        </p>
                      </div>
                    ))}
              ...
              <div className="mt-6 space-x-4">
                <Link
                  ...
                  className="px-1 py-1 bg-gray-800 text-white rounded hover:bg-gray-700 text-sm"
                >
                  View on GitHub
                </Link>
                <Link
                  href={project.apiDocsUrl}
                  className="px-1 py-1 border border-gray-800 rounded hover:bg-gray-100 text-sm"
                >
                  API Documentation
                </Link>
              </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center">
              ...
              <span>
                <a
                  href="https://www.linkedin.com/in/dennis-mwaura-735161228/"
                  target="_blank"
            ...
            <div className="flex items-center">
              ...
              <span>
                {" "}
                <a
                  href=" https://github.com/DennisMwauraKA"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-blue-600 hover:underline"
                >
